...
static void mrb_sdl2_video_displaymode_data_free(mrb_state *mrb,void *p)
{
  mrb_sdl2_video_displaymode_data_t *data=(mrb_sdl2_video_displaymode_data_t*)p;
  if(NULL!=data)
    mrb_free(mrb,data);
}

static void mrb_sdl2_video_window_data_free(mrb_state *mrb,void *p)
{
...
static void mrb_sdl2_video_glcontext_data_free(mrb_state *mrb,void *p)
{
  mrb_sdl2_video_glcontext_data_t *data=(mrb_sdl2_video_glcontext_data_t*)p;
  if(NULL!=data)
  {
...
static struct mrb_data_type const mrb_sdl2_video_displaymode_data_type={"DisplayMode",mrb_sdl2_video_displaymode_data_free};
static struct mrb_data_type const mrb_sdl2_video_window_data_type={"Window",mrb_sdl2_video_window_data_free};
static struct mrb_data_type const mrb_sdl2_video_glcontext_data_type={"GLContext",mrb_sdl2_video_glcontext_data_free};

SDL_Window *mrb_sdl2_video_window_get_ptr(mrb_state *mrb,mrb_value window)
{
  if(mrb_nil_p(window))
    return NULL;
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)mrb_data_get_ptr(mrb,window,&mrb_sdl2_video_window_data_type);
  return data->window;
}

mrb_value mrb_sdl2_video_window(mrb_state *mrb,SDL_Window *window)
{
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)mrb_malloc(mrb,sizeof(mrb_sdl2_video_window_data_t));
  if(NULL!=data)
...
mrb_value mrb_sdl2_video_associated_window(mrb_state *mrb,SDL_Window *window)
{
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)mrb_malloc(mrb,sizeof(mrb_sdl2_video_window_data_t));
  if(NULL!=data)
    mrb_raise(mrb,E_RUNTIME_ERROR,"insufficient memory.");
...
{
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)DATA_PTR(self);
  mrb_value title;
  mrb_int x,y,w,h,f;
  int const argc=mrb_get_args(mrb,"|Siiiii",&title,&x,&y,&w,&h,&f);
  if((0!=argc) && (6!=argc))
...
{
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)mrb_data_get_ptr(mrb,self,&mrb_sdl2_video_window_data_type);
  if(NULL==data->window)
    return mrb_nil_value();
...
static mrb_value mrb_sdl2_video_window_swap(mrb_state *mrb,mrb_value self)
{
  mrb_sdl2_video_window_data_t *data=(mrb_sdl2_video_window_data_t*)mrb_data_get_ptr(mrb,self,&mrb_sdl2_video_window_data_type);
  if(NULL==data->window)
    return mrb_nil_value();
...
{
  mrb_sdl2_video_glcontext_data_t *data=(mrb_sdl2_video_glcontext_data_t*)DATA_PTR(self);
  mrb_value window;
  ...
  if(0!=argc)
  {
    mrb_sdl2_video_window_data_t *window_data=(mrb_sdl2_video_window_data_t*)mrb_data_get_ptr(mrb,window,&mrb_sdl2_video_window_data_type);
...
{
  mrb_sdl2_video_glcontext_data_t *data=(mrb_sdl2_video_glcontext_data_t*)mrb_data_get_ptr(mrb,self,&mrb_sdl2_video_glcontext_data_type);
  mrb_value window;
...
void mruby_sdl2_video_init(mrb_state *mrb)
{
